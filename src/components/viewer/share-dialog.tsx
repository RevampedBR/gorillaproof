...
export function ShareDialog({ isOpen, onClose, proofId, proofTitle }: ShareDialogProps) {
    ...
    const shareUrl = typeof window !== "undefined"
        ? `${window.location.origin}/proofs/${proofId}`
        : `/proofs/${proofId}`;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div ref={dialogRef} className="bg-[#1e1e32] border border-[#3a3a55] rounded-2xl shadow-2xl w-[440px] p-6 animate-in fade-in zoom-in-95 duration-200">
                <div className="flex items-center justify-between mb-5">
                    <h3 className="text-[16px] font-bold text-white">Compartilhar Prova</h3>
                ...
                <p className="text-[13px] text-zinc-400 mb-4">
                    Compartilhe <span className="text-white font-medium">&quot;{proofTitle}&quot;</span> com sua equipe
                </p>
                ...
                {/* Invite by email */}
                <div className="mb-5">
                    <label className="text-[12px] text-zinc-400 font-medium mb-2 block">Convidar por e-mail</label>
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-[#2a2a40]">
                    <span className="text-[11px] text-zinc-500 font-medium">Compartilhar via:</span>
                    {[
