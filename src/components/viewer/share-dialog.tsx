            ...
            <div ref={dialogRef} className="bg-[#1e1e32] border border-[#3a3a55] rounded-2xl shadow-2xl w-[480px] p-6 animate-in fade-in zoom-in-95 duration-200">
                ...
                {!token ? (
                    <button
                        ...
                        disabled={generating}
                        className="w-full h-11 bg-emerald-600 hover:bg-emerald-700 disabled:bg-zinc-800 text-white text-[14px] font-semibold rounded-lg shadow-lg shadow-emerald-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:cursor-not-allowed mb-5"
                    >
                        {generating ? (
                        ...
                        <div className="space-y-1.5 max-h-[200px] overflow-y-auto">
                            {guests.map((g: any) => (
                                <div key={g.id} className="flex items-center gap-2.5 px-2 py-1.5 rounded-lg hover:bg-[#2a2a40]/50 transition-colors">
                                    <div className="h-7 w-7 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-800 flex items-center justify-center text-[10px] font-bold text-white shrink-0">
