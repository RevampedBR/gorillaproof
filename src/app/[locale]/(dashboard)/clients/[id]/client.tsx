        ...
        <div className="flex flex-col h-full max-w-6xl mx-auto">
            ...
            <div className="relative rounded-2xl mb-8 bg-gradient-to-br from-[#0a1f12] via-[#0d2818] to-[#0a2e1a] border border-zinc-800/50">
                ...
                <div className="relative z-10 px-8 py-8">
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                            <EditClientDialog client={client}>
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="border-zinc-700 text-zinc-300 hover:text-white hover:bg-zinc-800 text-[14px] h-11 w-11 p-0 rounded-xl font-semibold"
                                >
                            ...
                            <CreateProjectDialog clientId={client.id}>
                                <Button
                                    size="lg"
                                    className="text-white text-[14px] h-11 px-6 rounded-xl shadow-lg font-semibold"
                    ...
                    {/* Portal do Cliente */}
                    <div className="mt-6">
                        <PortalLinkSection clientId={client.id} clientName={client.name} />
                    </div>
                </div>
            </div>
                            ...
                            return (
                                <div key={project.id} className="group rounded-2xl border border-white/5 bg-zinc-950/40 overflow-hidden hover:border-zinc-700/60 transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-black/20">
                                    ...
                                    <div className="px-4 py-2.5 border-t border-white/5 bg-black/20 flex items-center justify-between">
                                        <CreateProofDialog clientId={client.id} projectId={project.id} clientName={client.name} projectName={project.name}>
            ...
            <div className="space-y-4 mt-8">
                ...
                {allProofs.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-12 text-center rounded-2xl border border-white/5 bg-zinc-950/40">
                        ...
                        <p className="text-[14px] font-medium text-zinc-300">Nenhuma prova neste cliente ainda.</p>
                        <p className="text-[12px] text-zinc-500 mt-1 max-w-sm">Envie sua primeira prova e comece a coletar feedback e aprovações da sua equipe.</p>
                        <div className="mt-5">
                            <CreateProofDialog clientId={client.id} clientName={client.name}>
